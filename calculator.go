...
import (
	...
	//"go get package github.com/Knetic/govaluate"
...
func showCalc() {
	...
	historyBtn := widget.NewButton("history", func() {
		...
		ishistory = !ishistory //if true then false v.v.
	...
	equalBtn := widget.NewButton("=", func() {
		...
		if err == nil {
			...
			if err == nil {
				ans := strconv.FormatFloat(result.(float64), 'f', -1, 64) //this is use to covert op to string
